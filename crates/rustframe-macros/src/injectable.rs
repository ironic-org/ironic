...
pub(crate) fn expand(input: TokenStream) -> syn::Result<TokenStream> {
    ...
    let mut scope = quote!(::rustframe::Scope::Singleton);
    let mut eager = false;
        ...
        attribute.parse_nested_meta(|meta| {
            ...
            if meta.path.is_ident("scope") {
                ...
                scope = match value.value().as_str() {
                    "singleton" => quote!(::rustframe::Scope::Singleton),
                    "transient" => quote!(::rustframe::Scope::Transient),
                    _ => {
        ...
        Data::Struct(data) => match &data.fields {
            Fields::Named(fields) => {
                ...
                for field in &fields.named {
                    ...
                    dependencies.push(quote!(::rustframe::Dependency::required::<#dependency>()));
                    initializers
    ...
    Ok(quote! {
        impl #name {
            ...
            pub fn provider_definition() -> ::rustframe::ProviderDefinition {
                ::rustframe::ProviderDefinition::factory(
                    #scope,
