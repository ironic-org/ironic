...
|---------|------|-----------|
| [v1.2.8](/blog/v1.2.8) | 2026-08-01 | add fetch_latest and poll_interval_ms to KafkaClientConfig and TransportConfig |
| [v1.2.7](/blog/v1.2.7) | 2026-07-28 | Auto-validation pipe ;  macro now automatically validates , ,  via  |
