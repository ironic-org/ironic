...
impl BlogsController {
    ...
    #[cache(ttl_secs = 30)]
    #[api(summary = "List blog posts", tag = "Blogs", security = "bearerAuth")]
    #[resp(200, "Paginated list of blog posts", json = Vec<BlogPost>)]
    async fn list(
        &self,
    ...
    #[get("/slug/:slug")]
    #[cache(ttl_secs = 60)]
    #[api(summary = "Get by slug", tag = "Blogs", security = "bearerAuth")]
    #[resp(200, "Blog post", json = BlogPost)]
    #[resp(404, "Post not found")]
    ...
    #[post]
    #[interceptor(TimingInterceptor)]
    #[api(summary = "Create post", tag = "Blogs", security = "bearerAuth")]
    #[body(json = CreateBlogDto)]
    #[resp(201, "Post created", json = BlogPost)]
    #[resp(422, "Validation error")]
    ...
    #[put("/:id")]
    #[interceptor(TimingInterceptor)]
    #[api(summary = "Update post", tag = "Blogs", security = "bearerAuth")]
    #[body(json = UpdateBlogDto)]
    #[resp(200, "Post updated", json = BlogPost)]
    #[resp(404, "Post not found")]
    async fn update(
        &self,
        #[param] id: Uuid,
    ...
    #[delete("/:id")]
    #[interceptor(TimingInterceptor)]
    #[api(summary = "Delete post", tag = "Blogs", security = "bearerAuth")]
    #[resp(204, "Post deleted")]
    #[resp(404, "Post not found")]
    ...
    #[post("/:id/publish")]
    #[api(summary = "Publish post", tag = "Blogs", security = "bearerAuth")]
    #[resp(200, "Post published", json = BlogPost)]
    #[resp(404, "Post not found")]
    ...
    #[post("/:id/unpublish")]
    #[api(summary = "Unpublish post", tag = "Blogs", security = "bearerAuth")]
    #[resp(200, "Post unpublished", json = BlogPost)]
    #[resp(404, "Post not found")]
    ...
    #[get("/stats")]
    #[cache(ttl_secs = 120)]
    #[api(summary = "Blog statistics", tag = "Blogs", security = "bearerAuth")]
    ...
    #[get("/:id/categories")]
    #[api(summary = "List post categories", tag = "Blogs", security = "bearerAuth")]
    #[resp(200, "Post categories", json = Vec<Category>)]
    #[resp(404, "Post not found")]
    ...
    #[api(summary = "Add category to post", tag = "Blogs", security = "bearerAuth")]
    #[resp(200, "Category added", json = BlogPost)]
    #[resp(404, "Post or category not found")]
    ...
    #[api(summary = "Remove category from post", tag = "Blogs", security = "bearerAuth")]
    #[resp(200, "Category removed", json = BlogPost)]
    #[resp(404, "Post or category not found")]
