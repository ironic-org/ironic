...
use rustframe_core::{build_http_application, compile_module_graph};
use rustframe_di::ContainerBuilder;
use rustframe_http::compile_controller_routes;
...
fn main() {
    ...
    runtime.block_on(async {
        ...
        report("RustFrame in-process request", REQUEST_ITERATIONS, started);
